...
import { getCompanyData, getProvinceById } from "@/modules/empresa/actions/general_actions";
...
export const GridCards = async () => {
  ...
  if (company.province_id) {
    const provinceData = await getProvinceById(company.province_id);
              ...
              <dl className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-base text-foreground">
                    {company.cities?.name}, {provinceName}
                  </dd>
                </div>
                <div>
